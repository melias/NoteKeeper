...
class DataManagerTest {
    ...
    fun addNote() {
        ...
        val noteText = "This is a the body of my test note"
    ...
    fun findSimilarNotes() {
        val course = DataManager.courses.get("android_async")!!
        val noteTitle = "This is a test note"
        val noteText1 = "This is a the body of my test note"
        val noteText2 = "This is a the body of my second test note"
